...
function startConversation() {
    fetch('https://chatbot-for-new-scholar-academy.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-new-scholar-academy.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbxJQMHON8vyHhBwK5qiPuZlfgqqDJimMTow0ye_KHbsts5tWbSAPkEyhQmKqCMqAqw7VA/exec';
